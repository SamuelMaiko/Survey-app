...
SECRET_KEY = 'django-insecure-lbn8+5enk$28di1x74q9$n9--ih4y$ng8j944l@ue(yy59oaex'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'railway',
        'USER': 'postgres',
        'PASSWORD': 'f1Dbg2df31cFDAeFD32EAdDb6C***EDC',
